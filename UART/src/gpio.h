...
/******************************************************************************
 *                 Register Abstraction for General-Purpose Input/OuT Type     *
 ******************************************************************************/
...
typedef struct
{ 
    __IO uint32_t PDOR; /* Port Data OuTypeut Register */
    __I  uint32_t PSOR; /* Port Set OuTypeut Register */
    __I  uint32_t PCOR; /* Port Clear OuTypeut Register */
    __I  uint32_t PTOR; /* Port Toggle OuTypeut Register */
    __O  uint32_t PDIR; /* Port Data Input Register */
